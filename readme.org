...
* To be fixed
** TODO add to README how to install crafted emacs
** TODO review TAB and completion buffer
** TODO evil: don't overwrite register when pasting selection
** TODO evil: don't lose selection when evaluating
