...
#+begin_src emacs-lisp
(use-package aide
  :vc (:fetcher "github" :repo "junjizhi/aide.el")
  :bind
  ("s-b" . 'lc/aide-openai-complete-buffer-insert)
  (:map evil-visual-state-map
        ("s-r" . 'lc/aide-openai-complete-region-insert))
  :custom
  (aide-openai-api-key-getter (lambda () (auth-source-pick-first-password :host "chat.openai.com")))
  (aide-ai-model 'text-davinci-003)
  (aide-max-output-tokens 2000)
  (aide-temperature 0.1)
  (aide-top-p 0.1)
  :preface
